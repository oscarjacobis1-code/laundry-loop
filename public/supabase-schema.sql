...
begin
  ...
  v_order := public.create_public_order(p_name,p_phone,p_items,p_notes,'In-Store Walk-In POS',current_date,p_payment,null,false);
...
revoke execute on function public.staff_create_order(text,text,jsonb,text,jsonb) from public, anon, authenticated;
