(function () {
  ...
  // Public tracking UI and progress rendering are owned by index.html.
  // Keep this production layer focused on persistence/auth so it cannot overwrite
  // the branded tracker after page load.
